...
pdf(filename = here::here("Figures", "Figure2Boxplot0to100.pdf"), width = 1400/81, height = 800/81)
grid.arrange(p)
dev.off()
...
pdf(filename = here::here("Figures", "Figure3Lambda.pdf"), width = 1400/81, height = 750/81)
...
pdf(filename = here::here("Figures", "Figure3pi.pdf"), width = 1400/81, height = 750/81)
