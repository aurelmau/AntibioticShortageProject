...
p<-ggplot(subset(df))+ #il faut utiliser la valeur Mean
  ...
  scale_color_manual(name = "Strategies", labels = c("Frequency use reduction (S1)","Treatment duration reduction (S2)","Dose/day reduction (S3)","Alternative treatment (S4)"),values=c("red" ,"green", "blue","#FDC257"))+
  scale_fill_manual(name = "Strategies", labels = c("Frequency use reduction (S1)","Treatment duration reduction (S2)","Dose/day reduction (S3)","Alternative treatment (S4)"),values=c("red" ,"green", "blue","#FDC257"))+
