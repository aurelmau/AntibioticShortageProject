...
gen <- odin::odin("Script\\DeuxAgeDeuxResistanceOdin.R")
...
optim(x0,OptimViFi,y=y,method="L-BFGS-B",lower=c(0.7,0.01), upper=c(1,0.3))
...
# optim(x0,OptimDose,method="L-BFGS-B",lower=c(0,0), upper=c(1,1))
