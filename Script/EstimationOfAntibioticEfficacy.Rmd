...
Optimi<-optim(par=c(0.72,0.01),OptimViFi,y=c(1,0.1),control = list(maxit = 20000))
...
```{r generate the evolution of carriage , include=FALSE}
...
```{r ggplot distribution des CMI S11}
t <- seq(0,10,0.1)
y_odin <- mod$run(t)
out_odin <- as.data.frame(y_odin)
