...
OptimDose <- function(x) {
  fi<-optim(par=c(0.72,0.01),OptimViFi,y=c(x[1],x[2]),control = list(maxit = 20000))$par[1]
  Vi=optim(par=c(0.72,0.01),OptimViFi,y=c(x[1],x[2]),control = list(maxit = 20000))$par[2]
...
for (i in 1:10) {
  ...
  x0 <- c(
    runif(1, min = 0.5,  max = 1.0),   # f
    runif(1, min = 0.01, max = 0.08)   # Beta (2e param)
  )
