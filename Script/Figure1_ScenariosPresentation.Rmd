...
p<-ggplot(out_long,aes(x=t,y=count,colour=Antibiotique,linetype=as.factor(Compartment)))+
  ...
  scale_y_continuous(
    name = "per 1,000 children per day",
    sec.axis = sec_axis(~ . / 1, name = "per 1,000 children")  # Divise par 10000 pour revenir à l'échelle originale de prop_am
  ) +
...
png("Figures\\FigureLegende1a.png", width = 500, height = 1200)
p
dev.off()
