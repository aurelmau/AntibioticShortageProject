...
write.csv(resultats, here::here("Files", "ResultsRCCN500_abs.csv"))



#Ouvrir fichier Resultats
resultats <- read.csv(here::here("Files", "ResultsRCCN500_abs.csv"))
...
write.csv(dfRCC, here::here("Files", "DataframePRCCN500_abs.csv"))
...
write.csv(resultats, here::here("Files", "ResultsRCCN500_noabs_bis.csv"))



#Ouvrir fichier Resultats
resultats <- read.csv(here::here("Files", "ResultsRCCN500_noabs_bis.csv"))
resultats<-subset(resultats, select = -X)
...
write.csv(dfRCC, here::here("Files", "DataframePRCCN500_noabs_bis.csv"))
...
resultats_PartialRankCorrelationCoefficients<-read.csv(here::here("Files", "DataframePRCCN500_abs.csv"))
...
#Ouvrir fichier Resultats
resultats_PartialRankCorrelationCoefficients<-read.csv(here::here("Files", "DataframePRCCN500_noabs_bis.csv"))
...
pdf(file = here::here("Figures", "FigureSupplementary4_PRCC.pdf"), width = 1200/81, height = 1200/81)
